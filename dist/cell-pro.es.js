...
function _(e) {
  ...
  return typeof e == "string" && (e = ot(e)), typeof e == "object" && (h(e.r) && h(e.g) && h(e.b) ? (n = Xe(e.r, e.g, e.b), u = !0, i = String(e.r).substr(-1) === "%" ? "prgb" : "rgb") : h(e.h) && h(e.s) && h(e.v) ? (r = I(e.s), a = I(e.v), n = tt(e.h, r, a), u = !0, i = "hsv") : h(e.h) && h(e.s) && h(e.l) && (r = I(e.s), o = I(e.l), n = Ke(e.h, r, o), u = !0, i = "hsl"), Object.prototype.hasOwnProperty.call(e, "a") && (t = e.a)), t = Je(t), {
    ok: u,
    format: e.format || i,
...
var rt = "[-\\+]?\\d+%?", at = "[-\\+]?\\d*\\.\\d+%?", k = "(?:".concat(at, ")|(?:").concat(rt, ")"), D = "[\\s|\\(]+(".concat(k, ")[,|\\s]+(").concat(k, ")[,|\\s]+(").concat(k, ")\\s*\\)?"), q = "[\\s|\\(]+(".concat(k, ")[,|\\s]+(").concat(k, ")[,|\\s]+(").concat(k, ")[,|\\s]+(").concat(k, ")\\s*\\)?"), b = {
...
var P = 2, de = 0.16, it = 0.05, lt = 0.05, ut = 0.15, Oe = 5, Te = 4, ft = [{
  index: 7,
  opacity: 0.15
}, {
  index: 6,
...
function pe(e) {
  var n = e.r, t = e.g, r = e.b, a = et(n, t, r);
  return {
    h: a.h * 360,
    s: a.s,
    v: a.v
...
function ve(e, n, t) {
  if (e.h === 0 && e.s === 0)
    return e.s;
  var r;
  return t ? r = e.s - de * n : n === Te ? r = e.s + de : r = e.s + it * n, r > 1 && (r = 1), t && n === Oe && r > 0.1 && (r = 0.1), r < 0.06 && (r = 0.06), Number(r.toFixed(2));
}
function me(e, n, t) {
  var r;
  return t ? r = e.v + lt * n : r = e.v - ut * n, r > 1 && (r = 1), Number(r.toFixed(2));
}
function G(e) {
  for (var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, t = [], r = _(e), a = Oe; a > 0; a -= 1) {
    var o = pe(r), u = z(_({
      h: ge(o, a, !0),
      s: ve(o, a, !0),
      v: me(o, a, !0)
  ...
  return n.theme === "dark" ? ft.map(function(y) {
    var C = y.index, s = y.opacity, c = z(st(_(n.backgroundColor || "#141414"), _(t[C]), s * 100));
    return c;
  }) : t;
}
var W = {
...
var be = "data-vc-order", gt = "vc-icon-key", Q = /* @__PURE__ */ new Map();
function Ae() {
  var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, n = e.mark;
  return n ? n.startsWith("data-") ? n : "data-".concat(n) : gt;
}
function X(e) {
  if (e.attachTo)
    return e.attachTo;
...
function je(e) {
  ...
  a.setAttribute(be, vt(r)), t && t.nonce && (a.nonce = t.nonce), a.innerHTML = e;
...
function ht(e, n) {
  ...
  var o = je(e, t);
  return o.setAttribute(Ae(t), n), o;
}
function he(e) {
...
function wt(e, n) {
  Ct(e, "[@ant-design/icons-vue] ".concat(n));
}
function ye(e) {
...
function St(e) {
  return J() ? Pe(e) instanceof ShadowRoot : !1;
}
function xt(e) {
  return St(e) ? Pe(e) : null;
}
var Ot = function() {
  var n = _e(), t = n.prefixCls, r = n.csp, a = De(), o = kt;
  t && (o = o.replace(/anticon/g, t.value)), qe(function() {
    if (J()) {
      var u = a.vnode.el, i = xt(u);
...
function jt(e) {
  ...
  M.primaryColor = n, M.secondaryColor = t || Ee(n), M.calculated = !!t;
}
function Et() {
  return N({}, M);
}
var x = function(n, t) {
  var r = N({}, n, t.attrs), a = r.icon, o = r.primaryColor, u = r.secondaryColor, i = _t(r, Tt), l = M;
  if (o && (l = {
    primaryColor: o,
    secondaryColor: u || Ee(o)
  }), wt(ye(a), "icon should be icon definiton, but got ".concat(a)), !ye(a))
    return null;
  var f = a;
...
x.getTwoToneColors = Et;
x.setTwoToneColors = jt;
const K = x;
function It(e, n) {
  return Bt(e) || $t(e, n) || zt(e, n) || Pt();
}
function Pt() {
...
function ze(e) {
  var n = Ie(e), t = It(n, 2), r = t[0], a = t[1];
...
ze(ct.primary);
var O = function(n, t) {
  var r, a = ke({}, n, t.attrs), o = a.class, u = a.icon, i = a.spin, l = a.rotate, f = a.tabindex, y = a.twoToneColor, C = a.onClick, s = Wt(a, Ft), c = _e(), T = c.prefixCls, j = c.rootClassName, H = (r = {}, A(r, j.value, !!j.value), A(r, T.value, !0), A(r, "".concat(T.value, "-").concat(u.name), !!u.name), A(r, "".concat(T.value, "-spin"), !!i || u.name === "loading"), r), F = f;
  F === void 0 && C && (F = -1);
  var He = l ? {
    msTransform: "rotate(".concat(l, "deg)"),
    transform: "rotate(".concat(l, "deg)")
  } : void 0, Fe = Ie(y), ae = Rt(Fe, 2), Re = ae[0], Ve = ae[1];
  return S("span", ke({
    role: "img",
    "aria-label": u.name
  }, s, {
...
te.inheritAttrs = !1;
const en = te, tn = { class: "copy-button-container" }, nn = /* @__PURE__ */ Z({
  __name: "ShareButton",
  props: {
    ...
    return (s, c) => {
      ...
      return d(), p("div", tn, [
        S(T, {
          ...
          icon: le(() => [
            a.value ? (d(), ue(fe(en), { key: 0 })) : (d(), ue(fe(Zt), { key: 1 }))
          ]),
          default: le(() => [
            Ue(" " + $(s.buttonText), 1)
          ]),
...
const Be = (e, n) => {
  ...
  for (const [r, a] of n)
    t[r] = a;
  return t;
}, ne = /* @__PURE__ */ Be(nn, [["__scopeId", "data-v-c7b4f365"]]), rn = { class: "help-link-container" }, an = ["href", "target", "rel"], on = {
  key: 0,
  ...
  viewBox: "0 0 24 24",
  fill: "currentColor"
}, bn = { class: "help-text" }, hn = /* @__PURE__ */ Z({
  __name: "HelpLink",
  props: {
    text: { default: "帮助" },
    href: { default: "" },
  ...
  setup(e, { emit: n }) {
    ...
    return (i, l) => (d(), p("div", rn, [
      i.href ? (d(), p("a", {
        ...
        i.iconType === "book" ? (d(), p("svg", on, l[4] || (l[4] = [
        ...
        ]))) : i.iconType === "question" ? (d(), p("svg", ln, l[5] || (l[5] = [
        ...
        i.iconType === "book" ? (d(), p("svg", pn, l[9] || (l[9] = [
          m("path", { d: "M21 5c-1.11-.35-2.33-.5-3.5-.5-1.95 0-4.05.4-5.5 1.5-1.45-1.1-3.55-1.5-5.5-1.5S2.45 4.9 1 6v14.65c0 .25.25.5.5.5.1 0 .15-.05.25-.05C3.1 20.45 5.05 20 6.5 20c1.95 0 4.05.4 5.5 1.5 1.35-.85 3.8-1.5 5.5-1.5 1.65 0 3.35.3 4.75 1.05.1.05.15.05.25.05.25 0 .5-.25.5-.5V6c-.6-.45-1.25-.75-2-1zm0 13.5c-1.1-.35-2.3-.5-3.5-.5-1.7 0-4.15.65-5.5 1.5V8c1.35-.85 3.8-1.5 5.5-1.5 1.2 0 2.4.15 3.5.5v11.5z" }, null, -1)
        ]))) : i.iconType === "question" ? (d(), p("svg", gn, l[10] || (l[10] = [
          m("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z" }, null, -1)
        ]))) : i.iconType === "info" ? (d(), p("svg", vn, l[11] || (l[11] = [
          m("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z" }, null, -1)
        ]))) : i.iconType === "external" ? (d(), p("svg", mn, l[12] || (l[12] = [
          m("path", { d: "M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z" }, null, -1)
        ]))) : E("", !0),
        m("span", bn, $(i.text), 1)
      ], 42, dn)),
...
const re = /* @__PURE__ */ Be(hn, [["__scopeId", "data-v-08021254"]]);
function Ne(e) {
  return Qe({
    ...e,
    shadowRoot: !1,
...
const yn = Ne(ne), Cn = Ne(re);
function wn() {
  customElements.get("share-button") || customElements.define("share-button", yn), customElements.get("help-link") || customElements.define("help-link", Cn);
}
const kn = {
  install(e) {
