<template>
  <div class="help-link-container">
    ...
    >
      ...
      <svg v-if="showExternalIcon" class="external-arrow" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div v-if="showTooltip && tooltip" class="tooltip" :class="tooltipPosition">
      {{ tooltip }}
    </div>
  </div>
</template>
...
.help-link.outline:hover:not(.disabled) {
...
.help-link.text:hover:not(.disabled) {
